...
if(isset($irhat) && $irhat)
{
    ...
    if($_GET["action"] == "new")
    {
        ...
        $stmt->bind_param('sssssssss', $_POST['helyiseg'], $_POST['igenylo'], $_POST['igenylesideje'], $_POST['vegrehajtasideje'], $_POST['munkavegzo1'], $_POST['munkavegzo2'], $_POST['leiras'], $_POST['eszkoz'], $_POST['ugyintezo']);
        $stmt->execute();
    ...
    elseif($_GET["action"] == "update")
    {
        ...
        $stmt->bind_param('sssssssssi', $_POST['helyiseg'], $_POST['igenylo'], $_POST['igenylesideje'], $_POST['vegrehajtasideje'], $_POST['munkavegzo1'], $_POST['munkavegzo2'], $_POST['leiras'], $_POST['eszkoz'], $_POST['ugyintezo'], $_POST['id']);
        $stmt->execute();
        if(mysqli_errno($con) != 0)
        {
