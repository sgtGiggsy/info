...
else
{
    ...
    $beosztasok = mySQLConnect("SELECT telefonkonyvbeosztasok.id AS id,
            ...
            WHERE telefonkonyvcsoportok.id > 1 AND (telefonkonyvbeosztasok.felhid IS NULL OR telefonkonyvbeosztasok.id = $id)
    ...
    $magyarazat = $beosztas = $beosztasnev = $elotag = $nev = $titulus = $rendfokozat = $belsoszam = $belsoszam2 = $kozcelu = 
    ...
    if(isset($_GET['id']))
    {
        ...
        else
        {
            $modositasok = mySQLConnect("SELECT telefonkonyvvaltozasok.beosztas AS beosztas,
                ...
                WHERE telefonkonyvvaltozasok.beosztas = $telszamid
            ...
            $modositaskerelmek = mySQLConnect("SELECT felhasznalok.nev AS bejelento, timestamp
                    ...
                    WHERE (telefonkonyvvaltozasok.beosztas = $beosztas OR telefonkonyvvaltozasok.felhid = $felhid)
                        AND telefonkonyvvaltozasok.modid = (SELECT id FROM telefonkonyvmodositaskorok ORDER BY id DESC LIMIT 1)
