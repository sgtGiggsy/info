...
else
{
    ...
    $kerdesadat = mySQLConnect("SELECT kerdesek.id as kerdesid, kerdesek.kerdes as kerdes, valaszszoveg, valaszok.id as valaszid, kep
    ...
    else
    {
        ...
        if($kerdes['kep'])
        {
            ?><center><img src="<?=$RootPath . "/images/vizsgakepek/" . $kerdes['kep']?>" width="500px"></center><?php
        }
        ?><h3><?=$kerdes['kerdes']?></h3>
