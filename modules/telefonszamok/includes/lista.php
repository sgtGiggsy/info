...
else
{
    ...
    <table id="<?=$tipus?>">
        ...
        foreach($telefonszamok as $telefonszam)
        {
            ...
            $kattinthatolink = $RootPath . "/telefonszamok/telefonszam/" . $telszamid;
            ?><tr class="trlink" <?=($telefonszam['manualis']) ? 'style="font-style: italic"' : "" ?>>
                ...
                <td><?=($csoportir) ? "<a href='$RootPath/telefonszamok/telefonszam/$telszamid?action=edit'><img src='$RootPath/images/edit.png' alt='Telefonszám szerkesztése' title='Telefonszám szerkesztése'/></a>" : "" ?></td>
            </tr><?php
        }
        ?></tbody>
    </table><?php
