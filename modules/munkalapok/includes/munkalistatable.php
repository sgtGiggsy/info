        ...
        <tbody><?php
            foreach($munkak as $munka)
            {
                ...
                ?><tr>
                    ...
                    <td><a style="cursor: pointer;" onclick="window.open('<?=$RootPath?>/munkalapok/munkaszerkeszt/<?=$munka['id']?>?print')"><?=$icons['print']?></a></td>
                    <td><?=($csoportir && $munka['modenged']) ? "<a href='$RootPath/munkalapok/munkaszerkeszt/$munkid'>" . $icons['edit'] . "</a>" : "" ?></td>
                </tr><?php
            }
        ?></tbody>
    </table><?php
