        ...
        <table id="<?=$tipus?>">
            <thead>
                <tr>
                    ...
                    <th class="tsorth"><p><span class="dontprint"><input type="text" id="f4" onkeyup="filterTable('f4', '<?=$tipus?>', 4)" placeholder="Portszám" title="Portszám"><br></span><span onclick="sortTable(4, 'i', '<?=$tipus?>')">Portszám</span></p></th>
