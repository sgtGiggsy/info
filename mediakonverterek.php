    ...
    <table id="<?=$tipus?>">
        <thead>
            <tr>
                ...
                <th class="tsorth"><p><input type="text" id="f9" onkeyup="filterTable('f9', '<?=$tipus?>', 9)" placeholder="Raktár" title="Raktár"><br><span onclick="sortTable(9, 's', '<?=$tipus?>')">Raktár</span></p></th>
                <th class="tsorth"><p><input type="text" id="f10" onkeyup="filterTable('f10', '<?=$tipus?>', 10)" placeholder="Hálózat" title="Hálózat"><br><span onclick="sortTable(10, 's', '<?=$tipus?>')">Hálózat</span></p></th>
                <th class="tsorth"><p><input type="text" id="f11" onkeyup="filterTable('f11', '<?=$tipus?>', 11)" placeholder="Megjegyzés" title="Megjegyzés"><br><span onclick="sortTable(11, 's', '<?=$tipus?>')">Megjegyzés</span></p></th><?php
                if($csoportir)
                {
                    ?><th></th>
                    <th></th>
