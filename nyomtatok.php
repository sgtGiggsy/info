    ...
    <div class="PrintArea">
        ...
        <thead>
            <tr>
                ...
                <th class="tsorth"><p><span class="dontprint"><input type="text" id="f6" onkeyup="filterTable('f6', '<?=$tipus?>', 6)" placeholder="Scanner" title="Scanner" list="scanner"><br></span><span onclick="sortTable(6, 's', '<?=$tipus?>')">Szkenner</span></p></th>
