...
else
{
    ...
    elseif($irhat && !$dbir)
    {
        ...
        if(isset($id))
        {
            ...
            $beuszok[] = array('cimszoveg' => 'Helyiségek generálása', 'formnev' => 'helyiseggenform');
            $beuszok[] = array('cimszoveg' => 'Végpontok generálása', 'formnev' => 'vegpontgenform');
            $beuszok[] = array('cimszoveg' => 'Új helyiség létrehozása', 'formnev' => 'helyisegszerkform');
        }
