<?php
if(!(isset($_SESSION['jogosultsag']) && $_SESSION['jogosultsag'] > 10))
{
...
else
{
    ...
    foreach($kitoltesek as $x)
    {
        ...
        else
        {
            ...
            $eredmeny = round($x['helyes']/$_SESSION['vizsgahossz']*100, 2);
        }
        
        if($x['helyes'] < $_SESSION['minimumhelyes'])
        {
